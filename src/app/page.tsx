                                            ...
                                            <div className="col-lg-6"> 
                                                <div className="sw-text-wrapper">
                                                    ...
                                                    <div className="animated anim-order-2">
                                                        ...
                                                        <a className="btn-main fx-slide animated fadeInUp anim-order-3" href="booking.html"><span>Book Shipment</span></a>
                            ...
                            <div className="h-100 relative bg-color p-5 text-light rounded-1">
                                ...
                                <div className="row align-items-center justify-content-end">
                                    ...
                                    <div className="col-md-3 col-sm-4">
                                        <a className="btn-main bg-white text-dark fx-slide w-100" href="track-result.html"><span>Track It</span></a>
                                    </div>
                                </div>
