...
<div className="no-bottom no-top" id="content">
            ...
            <section id="subheader" className="text-light sm-mt-90 relative rounded-1 overflow-hidden m-3" data-bgimage="url('images/background/3.webp') center">
                <div className="container relative z-2">
                    <div className="row gy-4 gx-5 align-items-center">
                        <div className="col-lg-12">
                            <h1 className="split">About Us</h1>
                        ...
                        <div className="col-lg-6">
                            <div className="relative">
                                <div className="w-100 pe-5 pb-5 wow scaleIn">
                                    <img src="images/misc/l1.webp" className="w-100 rounded-1" alt="Cargo logistics service" />
                                </div>
                                <img src="images/misc/s1.webp" className="w-40 rounded-1 abs end-0 bottom-0 z-2 soft-shadow wow scaleIn" data-wow-delay=".2s" alt="Freight transport" />
                            </div>
                        </div>
                        <div className="col-lg-6">
